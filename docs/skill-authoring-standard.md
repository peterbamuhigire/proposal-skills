...
This repository follows the July 2026 portable skill contract. The canonical engineering source is `C:\wamp64\www\chwezi-dev-engine`; this document translates the applicable contract for proposal skills without copying that engine.
...
python -X utf8 C:\wamp64\www\chwezi-dev-engine\skills\sdlc-meta\skill-engine-audit\scripts\engine_compliance.py --root . --active-root skills --details
```
