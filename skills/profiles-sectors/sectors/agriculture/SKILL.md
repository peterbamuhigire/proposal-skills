---
name: agriculture
description: Use when a proposal concerns agriculture, agribusiness, irrigation, value chains, extension, rural livelihoods, or food systems; use water-sanitation when WASH service delivery is the primary scope.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
|---|---|---|
| Sector-specific framing and methodology cues for agriculture and food-systems assignments. | Proposal lead, section writer, and evaluator-readiness reviewer | Applied consistently, traceable to the selected source, and free of unsupported identity, framework, or sector claims. |
...
|---|---|---|
| Value-chain boundary | Name the commodity or system, actors, geography, seasonality, and market constraint before choosing methods. | Generic rural-development methodology |
...
A solicitation requires **value-chain boundary**, but one controlling input is missing. The proposal team applies this rule: Name the commodity or system, actors, geography, seasonality, and market constraint before choosing methods. It records the gap and owner, withholds the affected assurance, and proceeds only with content that can be verified. This avoids **generic rural-development methodology**.

## References

- [Proposal skill router](../../../SKILL.md) — orchestration, profile, reasoning, and release gates.
<!-- dual-compat-end -->
- [references/uganda-agriculture-sector.md](references/uganda-agriculture-sector.md) for local sector context.
