---
name: governance
description: Use when a proposal concerns institutional reform, decentralisation, accountability, anti-corruption, public financial management, or public-service delivery; use education or health when sector outcomes dominate.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
|---|---|---|
| Sector-specific framing and methodology cues for governance assignments. | Proposal lead, section writer, and evaluator-readiness reviewer | Applied consistently, traceable to the selected source, and free of unsupported identity, framework, or sector claims. |
...
|---|---|---|
| Institutional mandate | Map the legal mandate, decision rights, incentives, political constraints, and service outcome before proposing reform. | Technocratic reform detached from authority and implementation |
...
A solicitation requires **institutional mandate**, but one controlling input is missing. The proposal team applies this rule: Map the legal mandate, decision rights, incentives, political constraints, and service outcome before proposing reform. It records the gap and owner, withholds the affected assurance, and proceeds only with content that can be verified. This avoids **technocratic reform detached from authority and implementation**.

## References

- [Proposal skill router](../../../SKILL.md) — orchestration, profile, reasoning, and release gates.
<!-- dual-compat-end -->
- [references/uganda-governance-sector.md](references/uganda-governance-sector.md) for local sector context.
