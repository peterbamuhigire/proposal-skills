...
description: Use when a proposal concerns roads, mobility, logistics, urban transport, infrastructure planning, asset management, or PPP advisory; use manufacturing-industrial for factory and warehouse operations.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
|---|---|---|
| Sector-specific framing and methodology cues for transport and infrastructure assignments. | Proposal lead, section writer, and evaluator-readiness reviewer | Applied consistently, traceable to the selected source, and free of unsupported identity, framework, or sector claims. |
...
|---|---|---|
| Asset and lifecycle scope | Define asset class, corridor or geography, demand, safeguards, operations, and maintenance responsibility. | Capital plan without lifecycle feasibility |
...
A solicitation requires **asset and lifecycle scope**, but one controlling input is missing. The proposal team applies this rule: Define asset class, corridor or geography, demand, safeguards, operations, and maintenance responsibility. It records the gap and owner, withholds the affected assurance, and proceeds only with content that can be verified. This avoids **capital plan without lifecycle feasibility**.

## References

- [Proposal skill router](../../../SKILL.md) — orchestration, profile, reasoning, and release gates.
<!-- dual-compat-end -->
- [references/uganda-transport-sector.md](references/uganda-transport-sector.md) for local sector context.
