---
name: education
description: Use when a proposal concerns education systems, TVET, teacher development, curriculum, edtech, institutional learning, or skills programmes; use governance when institutional reform is primary.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
|---|---|---|
| Sector-specific framing and methodology cues for education and learning assignments. | Proposal lead, section writer, and evaluator-readiness reviewer | Applied consistently, traceable to the selected source, and free of unsupported identity, framework, or sector claims. |
...
|---|---|---|
| Learning objective | Tie activities to learner group, baseline, delivery setting, assessment, and institutional owner. | Training activity without measurable learning or system change |
...
A solicitation requires **learning objective**, but one controlling input is missing. The proposal team applies this rule: Tie activities to learner group, baseline, delivery setting, assessment, and institutional owner. It records the gap and owner, withholds the affected assurance, and proceeds only with content that can be verified. This avoids **training activity without measurable learning or system change**.

## References

- [Proposal skill router](../../../SKILL.md) — orchestration, profile, reasoning, and release gates.
<!-- dual-compat-end -->
- [references/uganda-education-sector.md](references/uganda-education-sector.md) for local sector context.
