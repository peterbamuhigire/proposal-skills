---
name: energy
description: Use when a proposal concerns power systems, electrification, renewable energy, utilities, clean cooking, energy access, or sector reform; use transport-infrastructure for roads, mobility, or civil infrastructure.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
|---|---|---|
| Sector-specific framing and methodology cues for energy-sector assignments. | Proposal lead, section writer, and evaluator-readiness reviewer | Applied consistently, traceable to the selected source, and free of unsupported identity, framework, or sector claims. |
...
|---|---|---|
| Energy-system context | Distinguish grid, off-grid, utility, clean-cooking, or policy scope and verify the applicable technical and regulatory evidence. | Infeasible technology or wrong regulatory framing |
...
A solicitation requires **energy-system context**, but one controlling input is missing. The proposal team applies this rule: Distinguish grid, off-grid, utility, clean-cooking, or policy scope and verify the applicable technical and regulatory evidence. It records the gap and owner, withholds the affected assurance, and proceeds only with content that can be verified. This avoids **infeasible technology or wrong regulatory framing**.

## References

- [Proposal skill router](../../../SKILL.md) — orchestration, profile, reasoning, and release gates.
<!-- dual-compat-end -->
- [references/uganda-energy-sector.md](references/uganda-energy-sector.md) for local sector context.
