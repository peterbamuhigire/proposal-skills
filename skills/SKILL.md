...
| `skills/meta/operational-readiness-and-localisation/SKILL.md` | Ten-point local operating-readiness matrix, evaluator evidence, hold points, ownership, fallbacks, and cross-section reconciliation |
