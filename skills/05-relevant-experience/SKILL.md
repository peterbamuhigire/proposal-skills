...
1. The same type of assignment as the current bid
2. In the same country or sub-region as the client
3. For the same type of client (government ministry, NGO, regulatory body, private sector)
4. The largest or most prestigious engagements available
