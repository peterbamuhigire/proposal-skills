...
13. Impact evaluation design — method selection decision tree, identification strategy, counterfactual approach (see `references/impact-evaluation-and-economic-analysis.md` sections 3–4)
14. Power calculations and sample size — formula, cluster adjustment, minimum detectable effect (see `references/impact-evaluation-and-economic-analysis.md` section 5)
...
16. Analytics workstream — question framing, data inventory, quality profiling, analysis method, visualization, dashboard/report handover (see `../data-management/references/data-analytics-methodology-for-proposals.md`)
