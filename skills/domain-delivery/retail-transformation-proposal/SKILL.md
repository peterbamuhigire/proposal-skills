...
- Tender or client brief, including channels, store count, product categories, geography, and current systems.
- Known data availability: POS, orders, SKU master, inventory, returns, loyalty, CRM, promotions, vendor terms, labour, planogram, and dashboard exports.
- Target output: diagnostic, strategy, implementation support, software requirements, operating model, training, PMO, or managed improvement programme.
- Proposal profile and procurement format.
...
| New-store opening | site readiness, systems, staffing, launch | opening delays and avoidable first-month failures |
| KPI dashboard and WBR | dashboards, metrics, cadence, actions | meetings without source-backed decisions |

## Methodology Pattern

Use this phase structure unless the tender mandates a different format:

1. **Mobilise and evidence request:** confirm scope, stakeholders, workplan, data room, confidentiality, and decision cadence.
2. **Current-state diagnostic:** review data, systems, stores/channels, workflows, controls, customer journey, and management reports.
3. **Retail operating-model design:** define target capabilities, processes, roles, decision rights, data model, controls, KPIs, and governance cadence.
4. **Business case and prioritisation:** quantify or qualify value drivers without inventing market or financial figures; separate verified client data from assumptions.
5. **Implementation roadmap:** sequence workstreams, quick wins, dependencies, technology changes, training, pilots, rollout, and change management.
6. **Pilot and capability transfer:** test in selected stores/categories/channels, tune process and systems, train owners, and prepare adoption evidence.
7. **Performance management:** establish dashboards, weekly business review actions, benefits tracking, and post-implementation improvement loop.
...
- `skills/domain-delivery/accounting-finance-advisory/SKILL.md`
- `skills/strategy-positioning/embedded-accounting-engine-proposal/SKILL.md` where a system replaces bookkeeping/ERP workflows
- finance doctrine engine `skills/11-sector-and-fund-accounting/retail-and-pos-accounting-pack/SKILL.md`
