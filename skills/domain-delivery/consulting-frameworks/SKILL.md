...
| `references/strategic-options-evaluation.md` | Suitability, acceptability and feasibility screening (ranking matrix, scenario and capability screens, life-cycle matrix, three Rs, funding by life-cycle stage), four criteria for alternatives, strategies to avoid, programmed conflict, strategy diamond, decision memo | Any methodology that generates and chooses between options; the proposal's own options-considered section |
| `references/strategy-workshops-and-hypothesis-testing.md` | Quick hypothesis testing, analysis purpose, participation design, strategy-workshop design with bridges to action, co-staffing, issue-selling, decision-bias remedies, business-case and strategic-plan checklists | Strategy engagements, away-days, workshop series, co-delivered assignments |
| `references/product-reasoning-and-estimation.md` | Opportunity sizing, market-fit and threat checks, five-stage recommendation build (informed by CIRCLES), idea aids, prioritisation matrix, pricing triangle, goal-first measures, design critique | Product, service-design, feasibility, market-entry and digital assignments |
