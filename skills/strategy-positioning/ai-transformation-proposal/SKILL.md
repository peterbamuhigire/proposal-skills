...
Use the [technical proposal evidence bridge](../../profiles-sectors/references/technical-proposal-evidence-bridge.md) for evaluation cases, human oversight, fallback, AI cost drivers, and maintenance ownership.
<!-- dual-compat-end -->
