...
- `references/accounting-finance-proposal-gate.md` - detailed methodology, deliverables, scope/pricing drivers, and red flags.
- `../consulting-frameworks/references/accounting-finance-systems-diagnostics.md` - existing diagnostic reference.
- `../10-financial-proposal/SKILL.md` - pricing and commercial structure.
