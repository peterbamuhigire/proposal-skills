...
Before drafting or reviewing English, load the [human-English editorial standard](references/human-english-editorial-standard.md). For proposal sections, draft from the [proposal phrase bank](../../writing-content/premium-commercial-writing/references/proposal-phrase-bank.md) and its tone rules (specific over superlative, the client's words in needs and goals, one idea per sentence, reassurance not boasting, forward-looking conclusions, price stated plainly). It governs reader, purpose, genre, grammar, collocation, rhythm, and proof. Preserve local terminology where it is correct; do not equate formal English with inflated or bureaucratic English.
