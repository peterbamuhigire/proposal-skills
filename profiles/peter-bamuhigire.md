# Proposer Profile: Peter Bamuhigire (Individual Consultant)

## Identity

| Field | Value |
|---|---|
| **Full name** | Peter Bamuhigire |
| **Website** | techguypeter.com |
| **Email** | peter@techguypeter.com |
| **Phone** | +256 784 464178 |
| **Location** | Bukoto, Kampala, Uganda |
| **LinkedIn** | linkedin.com/in/peterbamuhigire |
| **GitHub** | github.com/peterbamuhigire |
| **Proposer type** | Individual consultant |
| **Voice** | First-person singular: "I propose…", "My approach will…", "I will…" |
| **Signatory** | Peter Bamuhigire |
...
<!-- TO COMPLETE: Regular teaming partners, sub-consultants you work with, firms you associate with for larger bids -->
- Principal of Chwezi Core Systems — can propose as individual consultant or through the firm depending on the assignment
<!-- Add other regular associates here -->

## Proposal Conventions

- **Cover letter signatory:** Peter Bamuhigire, Independent Consultant
- **Voice throughout:** First-person singular ("I", "my")
- **Firm profile section:** Becomes "Consultant Profile" — focus on individual expertise, qualifications, and track record
- **Team composition:** Peter as Team Leader / Lead Consultant, with any associates or sub-consultants listed separately
- **References:** Personal professional references from past clients
- **When to use this profile vs. Chwezi:** Use this profile when the ToR seeks an individual consultant, when the assignment is small-scale, or when personal technical expertise is the primary selection criterion. Use the Chwezi profile when the ToR requires an institutional proposer, when organisational depth and team size matter, or when the assignment requires multiple disciplines.
