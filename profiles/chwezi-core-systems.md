# Proposer Profile: Chwezi Core Systems

## Identity

| Field | Value |
|---|---|
| **Legal name** | Chwezi Core Systems Limited |
| **Trading as** | Chwezi Core Systems |
| **Tax ID** | 80034847127066 |
| **Website** | chwezi.co.za |
| **Email** | info@chwezi.co.za |
| **Phone** | +256 784 464178 |
| **Location** | Kampala, Central Region, Uganda |
| **LinkedIn** | linkedin.com/company/chwezi/ |
| **Proposer type** | Company |
| **Voice** | First-person plural: "We propose…", "Our team will…", "Chwezi Core Systems will…" |
| **Signatory** | Peter Bamuhigire, Managing Director <!-- CONFIRM TITLE --> |

## Company Summary

Chwezi Core Systems Limited is an integrated technology, business consulting, and security solutions firm headquartered in Kampala, Uganda. Established in December 2025, the firm delivers custom software development, enterprise systems, digital transformation, strategic consulting, and cybersecurity services to organisations across East Africa and beyond. Chwezi brings to market three proprietary SaaS platforms — Maduuka POS, Aqar Property Management, and Longhorn ERP — deployed across multiple countries, demonstrating end-to-end product delivery capability from concept through production support.
...
2. Enterprise systems and digital transformation
3. Website design and development (mobile-first, SEO-optimised)
4. Mobile application development (Android/iOS)
5. System development and integration

### Business Consulting
6. Strategic consulting and market analysis
7. Business plan development
8. Proposal writing and bid management
9. Operational optimisation and process improvement

### Security
10. Cybersecurity assessments and advisory
11. CCTV and surveillance systems
12. Physical security consulting

## Proprietary Software Products

| Product | Description | Status |
|---|---|---|
| **Maduuka POS** | Multi-tenant point-of-sale system for retail, pharmacy, and restaurant with inventory management, multi-branch support, and 5-language interface | Deployed |
| **Aqar Property Management** | Multi-property portfolio management platform with tenant tracking, lease management, and financial reporting | Deployed |
| **Longhorn ERP** | Cloud-based enterprise resource planning integrating finance, HR, inventory, and procurement | Deployed |
| **Medic8** | Healthcare management system | In development |
| **Kampus Pad** | Student housing platform | In development |
...
<!-- TO COMPLETE: Regular JV partners, sub-consultants, teaming arrangements for specific sectors or geographies -->
- Peter Bamuhigire available as individual consultant for assignments requiring a named expert rather than institutional capacity
<!-- Add other regular associates and partner firms here -->

## Proposal Conventions

- **Cover letter signatory:** Peter Bamuhigire, Managing Director, Chwezi Core Systems Limited <!-- CONFIRM TITLE -->
